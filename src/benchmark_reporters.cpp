...
BenchmarkProgressReporter::BenchmarkProgressReporter(int num_runs) : bar_(num_runs, true, std::cout) {}
...
bool BenchmarkProgressReporter::ReportContext(const Context& context) { return true; }